...
<body>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a class="p-2 text-dark" href="<?php echo base_url().'dashboard' ?>">Dashboard</a></h5>
  ...
  <div class="nav-scroller bg-white box-shadow">
    <nav class="nav nav-underline">
      ...
      <a class="nav-link" href="<?php echo base_url().'dashboard/datapertanyaan' ?>">Pertanyaan Mahasiswa</a>
    </nav>
  </div>
  <br><br>