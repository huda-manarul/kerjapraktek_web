<div class="container">
  <div class="my-3 p-3 bg-white rounded box-shadow">
    ...
    foreach($user as $u){ 
      ...
      <div class="media text-muted pt-3">
        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
          <strong class="d-block text-gray-dark"><?php echo $u->pertanyaan?></strong>
          <hr>
          <?php echo $u->jawaban ?>
        </div>
      </div>
    ...
    <form action="<?php echo base_url().'mahasiswa/tambahpertanyaan' ?>" method="post">
    <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="Tulis pertanyaan anda" name="pertanyaan" >
